...
function devicePicker(){
  ...
  return `<div class="picker-backdrop"><section class="device-picker" role="dialog" aria-label="Supported devices"><div class="picker-handle"></div><div class="picker-title"><strong>Check supported devices</strong><button data-action="close-picker" aria-label="Close">×</button></div><input id="picker-search" class="search" value="${pickerQuery}" placeholder="Search iPhone, Samsung, Pixel…" autofocus />${listMarkup}</section></div>`;
}
